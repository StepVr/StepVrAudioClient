...
namespace NF
{
    public class TCPClient
    {
        ...
        public void Disconnect()
        {
            ...
            //{
            //    Delegate[] Dels = ClientConnected.GetInvocationList();
            ...
            //        ClientConnected -= del as DelegateConnection;
            //    }
            //}
            ...
            //        string funcName = (string)delObj.GetType().GetProperty("Name").GetValue(delObj, null);////方法名
            //        Console.WriteLine(funcName);
            //        ExceptionAppeared -= del as DelegateException;
            //    }
            //}
            ...
            //        string funcName = (string)delObj.GetType().GetProperty("Name").GetValue(delObj, null);////方法名
            //        Console.WriteLine(funcName);
            //        DataReceived -= del as DelegateDataReceived;
            //    }
            //}
